...
class ControlListener(threading.Thread):
    ...
    def handleMessage(self, data):
        ...
        elif data == 'PLAYPREV':   self.keyboard.tap(Key.media_previous)
        elif data == 'PLAYNEXT':   self.keyboard.tap(Key.media_next)
        elif data == 'PLAYPAUSE':  self.keyboard.tap(Key.media_play_pause)
        elif data == 'VOLUMEUP':   self.keyboard.tap(Key.media_volume_up)
        elif data == 'VOLUMEDOWN': self.keyboard.tap(Key.media_volume_down)
        elif data == 'MUTE':       self.keyboard.tap(Key.media_volume_mute)
